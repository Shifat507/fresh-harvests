...
import { FaApple, FaApplePay, FaCcPaypal, FaGooglePlay } from 'react-icons/fa6';
        ...
        <div>
            <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
                ...
                <nav>
                    ...
                    <div className='mt-16'>
                        <h4 className='text-md font-semibold mb-3'>Accepted Payment Methods:</h4>
            ...
            <footer className="footer sm:footer-horizontal bg-base-200 text-base-content items-center px-10 pb-10">
